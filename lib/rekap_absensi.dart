...
import 'package:cloudabsen/rekap_masuk.dart';
import 'package:cloudabsen/rekap_pulang.dart';
import 'package:cloudabsen/rekap_absen.dart';
...
class RekapAbsensi extends StatefulWidget {
  RekapAbsensi({this.nik,this.nama_karyawan,this.status});
  final String nik;
...
class _RekapAbsensiState extends State<RekapAbsensi> with TickerProviderStateMixin {
  ProgressDialog pr;
  ...
  TextEditingController tanggal_rekap = TextEditingController();
  ...
  Widget yaa(){
    if(tanggal_rekap.text != ''){
      return RekapMasuk(
        nik:widget.nik,
        tanggal: tanggal_rekap.text,
      );
    }else{
      return RekapMasuk(
        nik:widget.nik,
              ...
              child: Row(
                ...
                children: <Widget>[
                  Container(
                    width:200,
                    child: DateTimeField(
                      controller: tanggal_rekap,
                      decoration: new InputDecoration(
                        labelStyle: TextStyle(
                            fontSize: 13
                        ),
                        labelText: "Cari Tanggal Rekap",
                                              ...
                                              // get the color of the button's background (dependent of its state)
                                                ...
                                                child: Row(
                                                  children: <Widget>[
                                                    ...
                                                    Container(width: 10,),
                                                    Text(_text[index],style: TextStyle(color: _getForegroundColor(index),fontSize: 13),),
                                                  ],
                                                )
                                            ),
                                          )));
                                              ...
                                              // get the color of the button's background (dependent of its state)
                                                ...
                                                child: Row(
                                                  children: <Widget>[
                                                    ...
                                                    Container(width: 10,),
                                                    Text(_text[index],style: TextStyle(color: _getForegroundColor(index)),),
                                                  ],
                                                )
                                            ),
                                          )));
