...
class RekapMasuk extends StatefulWidget {
  RekapMasuk({this.nik,this.tanggal});
  final nik;
  final tanggal;

  @override
  _RekapMasukState createState() => _RekapMasukState();
}

class _RekapMasukState extends State<RekapMasuk> {
...
//                                leading: Image.asset('Assets/img/Screenshot_1352.png',fit: BoxFit.fill,width: 70,),
                  title: Column(
                    ...
                    children: <Widget>[
                      Text('Absen Masuk Pada Tanggal',style: TextStyle(
                          fontSize: 12,
  ...
  Future<void> Notifx(jml) async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Data Rekap Absensi Masuk',style: TextStyle(
            fontSize: 14
          ),),
...
//                            final list = snapshot.data[i];
              ...
              return new Container(
                ...
                child: ListTile(
                  ...
                  onTap: (){
                      Cek(snapshot.data[i]['jam'], 'Scan In',snapshot.data[i]['jml']);
                  },
                ),
              );
            },
