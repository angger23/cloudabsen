...
class KelolaMasuk extends StatefulWidget {
  KelolaMasuk({this.nik,this.nama_karyawan,this.status});
  final String nik;
  ...
  @override
  _KelolaMasukState createState() => _KelolaMasukState();
}

class _KelolaMasukState extends State<KelolaMasuk> {
...
//    var response = await http.get(uri);
  ...
  Cek(nik,jam)async{
    final response = await http.post(Uri.parse("https://android.stikesbanyuwangi.ac.id/p/cari_telat"),body: {
      "nik": nik,
      "tanggal":jam,
    });
  ...
  Future<void> Notifx(nik,jam,alasan,gambar) async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Alasan Keterlambatan',style: TextStyle(
//              fontSize: 14
          ),),
