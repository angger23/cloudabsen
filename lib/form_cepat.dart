...
class FormCepat extends StatefulWidget {
  FormCepat({this.nik,this.nama_karyawan,this.status,this.tanggal});
  final String nik;
  ...
  @override
  _FormCepatState createState() => _FormCepatState();
}

class _FormCepatState extends State<FormCepat> {
  TextEditingController alasanIzin = TextEditingController();
  ProgressDialog pr;

  File imageURI;
  static final String uploadEndPoint =
      'https://android.stikesbanyuwangi.ac.id/p/form_cepatx';
  Future<File> file;
  String status = '';
  String base64Image;
  File tmpFile;
...
//                ),),
  ...
  CekCepat()async{
    final response = await http.post("https://android.stikesbanyuwangi.ac.id/p/cek_pulangx", body: {
      "nik": widget.nik,
      "tanggal":widget.tanggal,
    });
    var datauser = jsonDecode(response.body);
    setState(() {
      stat_cepat= datauser['stat'].toString();
    });
  }
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('Halaman ini digunakan untuk mengisi form pulang cepat',style: TextStyle(
                          fontSize: 10,
                          color: Colors.white,
                          fontFamily: 'Roboto-Light',
                          fontWeight: FontWeight.w700
                      ),),
                      Text('Jika anda pulang terlebih dahulu',style: TextStyle(
                          fontSize: 10,
                          color: Colors.white,
                          fontFamily: 'Roboto-Light',
                          fontWeight: FontWeight.w700
