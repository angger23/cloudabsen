...
class KelolaAlpha extends StatefulWidget {
  KelolaAlpha({this.nik,this.nama_karyawan,this.status});
  final String nik;
  ...
  @override
  _KelolaAlphaState createState() => _KelolaAlphaState();
}

class _KelolaAlphaState extends State<KelolaAlpha> {
